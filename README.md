# Eventure Photos - an app that makes sharing your experiences easier
...
Blog post on Eventure Photos: http://jessiehuff.com/eventure_photos 
...
To install and use this project, fork and clone the repo. Then, cd eventure-photos, run `bundle install` and `rake db:migrate` (along with any other dependencies you may be missing) in your command line, start a local server (by running `rake start`) and navigate to localhost:3000/.  
